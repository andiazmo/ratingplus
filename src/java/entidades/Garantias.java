...
@NamedQueries({
    ...
    @NamedQuery(name = "Garantias.findByNombre", query = "SELECT g FROM Garantias g WHERE g.nombre = :nombre")})
public class Garantias implements Serializable {
    ...
    public Garantias(String id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "entidades.Garantias[ id=" + id + " ]";
    }
