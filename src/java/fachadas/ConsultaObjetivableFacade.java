...
public class ConsultaObjetivableFacade extends AbstractFacade {
    ...
    public List<List<VariablesRating>> listarRespuestasVariablesRating(){
        ...
        listaRespuestasVariablesModulo.
                add(listarRespuestasVariablesObjetivo(listaRespuestasVariables));
    ...
    public List<VariablesRating> listarVariablesResultado(List<VariablesRating> 
            listaVariables){
    ...
    public List<ClientesRating> consultaClienteGrupoResultadoSinResRating
        ...
        listaProvisional = em.createNativeQuery(query).
                setParameter(1, tipoConsulta.equals("2") ? Integer.
                        parseInt(parametro) : parametro).getResultList();
        i = listaProvisional.iterator();
        
        while(i.hasNext()){
            Object[] object = (Object[]) i.next();
            BigDecimal valorProvisional = object[5] == null ? 
